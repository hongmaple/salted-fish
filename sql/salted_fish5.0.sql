...
) ENGINE = InnoDB AUTO_INCREMENT = 72 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评价/评论' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_flower`  (
                              ...
                              `depositing_time` datetime NULL DEFAULT NULL COMMENT '寄放时间',
